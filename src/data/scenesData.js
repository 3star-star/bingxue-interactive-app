    ...
    hotspots: [
      {
        id: "h1",
        title: "少女峰",
        description: "阿尔卑斯山的标志性山峰",
        position: { x: 30, y: 40 }
      },
      {
        id: "h2",
        title: "冰川湖",
        description: "由冰川融水形成的美丽湖泊",
        position: { x: 60, y: 70 }
      },
      {
        id: "h3",
        title: "滑雪场",
        description: "世界著名的滑雪胜地",
        position: { x: 20, y: 60 }
      }
    ],
    ambientSound: "wind"
    ...
    hotspots: [
      {
        id: "h1",
        title: "小樽运河",
        description: "冬日运河两岸的雪松夜景",
        position: { x: 45, y: 50 }
      },
      {
        id: "h2",
        title: "富良野雪原",
        description: "广阔的雪原和梦幻的雾凇",
        position: { x: 70, y: 30 }
      }
    ],
    ambientSound: "snow"
    ...
    hotspots: [
      {
        id: "h1",
        title: "企鹅栖息地",
        description: "成群的帝企鹅在冰面上行走",
        position: { x: 40, y: 60 }
      },
      {
        id: "h2",
        title: "冰山群",
        description: "巨大的冰山漂浮在海面上",
        position: { x: 80, y: 40 }
      }
    ],
    ambientSound: "ice"
    ...
    hotspots: [
      {
        id: "h1",
        title: "极光",
        description: "绚丽的北极光舞动",
        position: { x: 60, y: 30 }
      },
      {
        id: "h2",
        title: "北极熊",
        description: "北极霸主在冰面上漫游",
        position: { x: 40, y: 50 }
      }
    ],
    ambientSound: "aurora"
